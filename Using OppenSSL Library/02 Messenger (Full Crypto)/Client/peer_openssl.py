...
Handshake protocol (both sides symmetric):
    Each peer sends a single framed message containing three length-prefixed fields:
...
class Peer:
    def __init__(self, is_server, host="127.0.0.1"):
    ...
    def _handshake(self):
        ...
        Client sends first, then receives (server is the mirror image).
        """
        ...
        # --- Verify peer's ECDSA signature over their ECDH public key ---
